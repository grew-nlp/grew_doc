...
For instance, the file `en_fr_zh.json` [:link:](/usage/input/en_fr_zh.json) describes 3 corpora from UD 2.17 (of course, directories should be modified to match your local installation).
