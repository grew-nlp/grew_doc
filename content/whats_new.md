...
### Version 1.21 (July 30, 2026)
  ...
  - ⚠️ Corpora must be recompiled after update to this version
...
### Version 1.18 (July 15, 2025)
 - Constraints about global structure and metadata are now available in `pattern`, `with` or `without` (See [request page](../../doc/request/#constraints-on-the-global-properties-of-the-graph).)
